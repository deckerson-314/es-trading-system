...
def group_params_for_display(params_dict_local):
    ...
    groups = {
        'Entry Criteria': ['Enable Long Trades', 'Enable Short Trades', 'Bollinger Band Length', 
                          ...
                          'ATR Length for Filter', 'Max ATR Filter (Points)', 'Min ATR Filter (Points)', 'RTH Start (HH:MM)', 
                          'RTH End (HH:MM)', 'Enable RTH Filter', 'RTH Exit Buffer (minutes)',
                          'Volume MA Length', 'Max Volume Multiplier', 'Timeframe (minutes)', 'Max Open Trades'],
