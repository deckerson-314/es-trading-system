        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <p class="text-muted">
                    ...
                    <span style="color:green; font-weight:bold;">ΓùÅ</span> = Highly Converged (Top 25%), 
                    <span style="color:red; font-weight:bold;">ΓùÅ</span> = Divergent/Searching (Bottom 25%).
                </p>
        """
        ...
        for group_name, p_list in groups.items():
            ...
            for pname in valid_list:
                ...
                if pname in optimized_params and pname in stats.index:
                    ...
                    std_pct = row['std_pct']
                    if std_pct <= q25:
                        symbol = '<span style="color:green; font-weight:bold;" title="Converged">ΓùÅ</span>'
                    elif std_pct >= q75:
                        symbol = '<span style="color:red; font-weight:bold;" title="Divergent">ΓùÅ</span>'
                    else:
                        symbol = '<span style="color:gray;" title="Stable">Γùï</span>'
                else:
                    # Fixed Parameter
                    mean_val = str(val)
                    std_val = "-"
